...
public enum UIPathBasicEnum {
    ...
    UIPathBasicEnum(String name, String path) {
        this.name = name;
        this.path = path;
    }

    public static String getPath(String name) {
        for (UIPathBasicEnum uiPathBasicEnum : UIPathBasicEnum.values()) {
            if (uiPathBasicEnum.getName() == name) {
                return uiPathBasicEnum.getPath();
            }
        }
        return "";
    }
