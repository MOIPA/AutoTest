...
public enum UIPathOriganizationEnum {
    ...
    ENTERPRISE_ORGANIZATION("enterprise_organization","//*[@id=\"app\"]/div/div[2]/div[1]/div/div[1]/div[1]/div/div[2]/div[3]");


    private String name;
    private String path;

    UIPathOriganizationEnum(String name, String path) {
        this.name = name;
        this.path = path;
    }

    public static String getPath(String name) {
        for (UIPathOriganizationEnum uiPathEnum : UIPathOriganizationEnum.values()) {
